...
- (CGSize)contentSize {
    ...
    size = [self.message sizeAttributedWithFont:[UIFont systemFontOfSize:[ZIMKitMessageCellConfig messageTextFontSize]] width:ZIMKitMessageCell_Text_MaxW wordWap:NSLineBreakByCharWrapping];
