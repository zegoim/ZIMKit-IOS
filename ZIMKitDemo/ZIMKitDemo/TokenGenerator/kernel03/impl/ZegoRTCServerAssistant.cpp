#include "ZegoRTCServerAssistant.h"
#include "ZegoRTCServerAssistantDefines.h"
...
{
    ZegoTokenResult ZegoRTCServerAssistant::GenerateToken(uint32_t appID, const std::string& roomID, const std::string& userID,
      const std::map<int, int>& privilege, const std::string& secret, int64_t effectiveTimeInSeconds)
    {
        ...
        ZegoRTCServerAssistantImpl serverAssistantImpl;
        std::string             result
