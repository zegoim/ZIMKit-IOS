...
#include "../../common/modules/common/ZegoCrypto.hpp"
#include "Base64.h"
#include "ZegoRTCServerAssistantImpl.h"
#include "json_tools.hpp"

namespace ZEGO
{
namespace SERVER_ASSISTANT03
{
    std::string ZegoRTCServerAssistantImpl::GenerateToken(uint32_t appID, const std::string& roomID, const std::string& userID,
    ...
    int64_t ZegoRTCServerAssistantImpl::MakeNonce()
    {
    ...
    std::string ZegoRTCServerAssistantImpl::MakeRandomIv()
    {
    ...
    std::string ZegoRTCServerAssistantImpl::TokenToJson(const TokenParams& params)
    {
    ...
    std::string ZegoRTCServerAssistantImpl::AesEncrypt(
